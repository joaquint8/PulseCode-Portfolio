const PulseLogo = ({ className = "" }) => {
  return (
    <div className={`relative flex items-center justify-center ${className}`}>
      ...
      <div className="relative z-10 w-[280px] h-[280px] sm:w-[320px] sm:h-[320px] flex items-center justify-center p-6 bg-background/30 backdrop-blur-md rounded-3xl border border-white/10 shadow-2xl transition-all duration-500 hover:scale-105">
        <img
